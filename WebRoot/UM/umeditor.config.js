...
(function () {
     ...
     */
    var PATH = (function(){
    	//这里改写um原来的获取路径方法，获取根据script标签引用文件的路径，获取contextPath
    	//所以千万不要将这个js文件改名 
    	var scripts = document.getElementsByTagName("script");
    	var src = null;
    	for(var i=0;i<scripts.length;i++){
    		if(scripts[i].src.indexOf("\/UM\/umeditor.config.js")!=-1){
    			src = scripts[i].src;
    			break;
    		}
    	}
    	...
    	return src.substring(0,src.indexOf("\/UM\/umeditor.config.js"));
    })();
    ...
    window.UMEDITOR_CONFIG = {
        ...
        UMEDITOR_HOME_URL : PATH+"/UM/"

        //图片上传配置区
        ,imageUrl:PATH+"/um/imageUP"             //图片上传提交地址
